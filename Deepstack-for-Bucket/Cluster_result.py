...
def cluster_result_main(street):

    cluster_result = CLUSTER_RESULT(street=street, file_path=settings.file_path, turn_sample_count=20, river_sample_count=10, opponent_sample_count=20,
