...
class Evaluator(object):
    ...
    def get_winner(self, board, hands, verbose=True):
        ...
        for player, hand in enumerate(hands):
            ...
            rank = self.evaluate(hand, board[:5])
        ...
        if verbose:
            print('---')
            print('p1: {} {}'.format(Card.int_to_str(hands[0][0]), Card.int_to_str(hands[0][1])))
            print('p2: {} {}'.format(Card.int_to_str(hands[1][0]), Card.int_to_str(hands[1][1])))
            print('board: {} {} {} {} {}'.format(Card.int_to_str(board[0]), Card.int_to_str(board[1]),
                                                 Card.int_to_str(board[2]), Card.int_to_str(board[3]),
                                                 Card.int_to_str(board[4])))
            print('Winner ')
